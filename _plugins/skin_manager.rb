...
module MinimaSkin
  ...
  Jekyll::Hooks.register :site, :post_read do |site|
    ...
    MinimaSkin.available_skins = Dir["#{skins_dir}/*.scss"].map { |i| File.basename(i, ".scss") }
  end

  Jekyll::Hooks.register [:pages, :documents], :pre_render do |doc, payload|
    payload["page"]["available_skins"] = MinimaSkin.available_skins
  end
  ...
  class StyleSheetGenerator < Jekyll::Generator
    def generate(site)
      MinimaSkin.available_skins.each do |skin_name|
