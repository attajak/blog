# Thanks: Jekyll Minima theme <https://github.com/jekyll/minima>
...
module SkinSwitch
  ...
  Jekyll::Hooks.register :site, :post_read do |site|
    ...
    SkinSwitch.available_skins = Dir["#{skins_dir}/*.scss"].map { |i| File.basename(i, ".scss") }
  end

  Jekyll::Hooks.register [:pages, :documents], :pre_render do |doc, payload|
    payload["page"]["available_skins"] = SkinSwitch.available_skins
  end
  ...
  class StyleSheetGenerator < Jekyll::Generator
    def generate(site)
      SkinSwitch.available_skins.each do |skin_name|
